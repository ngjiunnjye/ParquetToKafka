...
libraryDependencies += "com.github.mjakubowski84" %% "parquet4s-core" % "1.1.0"
libraryDependencies += "org.apache.hadoop" % "hadoop-client" % "3.2.1"
libraryDependencies += "org.apache.hive" % "hive-jdbc" % "1.2.2"
libraryDependencies += "com.jsoniter" % "jsoniter" % "0.9.19"
libraryDependencies += "org.apache.hbase" % "hbase-client" % "1.2.12"
libraryDependencies += "org.apache.hbase" % "hbase-common" % "1.2.12"
